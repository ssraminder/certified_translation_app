...
const ApiTest: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0E3CB5] text-white font-sans p-4 sm:p-6 lg:p-8">
      <div className="max-w-3xl mx-auto">
        <header className="text-center mb-10">
          <h1 className="text-3xl font-bold text-white">API Test Console</h1>
          <p className="mt-4 text-[#89A2E3]">Use these buttons to test backend API endpoints.</p>
        </header>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20">
              <div>
                ...
                <p className="font-mono text-xs text-[#ACACAC]">/ping</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-cyan-600 text-white font-semibold py-1.5 px-4 rounded-md text-sm hover:bg-cyan-500 transition-colors duration-200 disabled:bg-white/20 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0E3CB5] focus:ring-cyan-500"
                >
            ...
            <div className="flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20">
              <div>
                <p className="font-semibold text-white">Supabase Connection</p>
                <p className="font-mono text-xs text-[#ACACAC]">/supabase</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-green-600 text-white font-semibold py-1.5 px-4 rounded-md text-sm hover:bg-green-500 transition-colors duration-200 disabled:bg-white/20 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0E3CB5] focus:ring-green-500"
                >
            ...
            <div className="flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20">
              <div>
                <p className="font-semibold text-white">Vision API</p>
                <p className="font-mono text-xs text-[#ACACAC]">/vision</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white font-semibold py-1.5 px-4 rounded-md text-sm hover:bg-blue-500 transition-colors duration-200 disabled:bg-white/20 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0E3CB5] focus:ring-blue-500"
                >
            ...
            <div className="flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20">
              <div>
                <p className="font-semibold text-white">Gemini API</p>
                <p className="font-mono text-xs text-[#ACACAC]">/gemini</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-purple-600 text-white font-semibold py-1.5 px-4 rounded-md text-sm hover:bg-purple-500 transition-colors duration-200 disabled:bg-white/20 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0E3CB5] focus:ring-purple-500"
                >
            ...
            <div className="flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20">
              <div>
                <p className="font-semibold text-white">Stripe API</p>
                <p className="font-mono text-xs text-[#ACACAC]">/stripe</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-red-600 text-white font-semibold py-1.5 px-4 rounded-md text-sm hover:bg-red-500 transition-colors duration-200 disabled:bg-white/20 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0E3CB5] focus:ring-red-500"
                >
            ...
            <div className="flex items-center justify-between bg-white/10 p-3 rounded-lg border border-white/20">
              <div>
                <p className="font-semibold text-white">Brevo API</p>
                <p className="font-mono text-xs text-[#ACACAC]">/brevo</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-orange-600 text-white font-semibold py-1.5 px-4 rounded-md text-sm hover:bg-orange-500 transition-colors duration-200 disabled:bg-white/20 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#0E3CB5] focus:ring-orange-500"
                >
